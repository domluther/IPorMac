...
const buttonVariants = {
  ...
  `,
	"answer-correct": `
    relative py-3 sm:py-4 px-6 sm:px-12 text-base sm:text-lg font-semibold rounded-lg border-2 
    bg-stats-accuracy-high text-white border-stats-accuracy-high shadow-lg
    transition-all duration-200
  `,
	"answer-incorrect": `
    relative py-3 sm:py-4 px-6 sm:px-12 text-base sm:text-lg font-semibold rounded-lg border-2 
    bg-stats-accuracy-low text-white border-stats-accuracy-low shadow-lg
    transition-all duration-200
  `,
...
const shortcutVariants: Partial<Record<QuizButtonVariant, string>> = {
	...
	"answer-correct":
		"absolute top-3 left-3 w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold shadow-sm bg-white text-stats-accuracy-high",
	"answer-incorrect":
		"absolute top-3 left-3 w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold shadow-sm bg-white text-stats-accuracy-low",
};
